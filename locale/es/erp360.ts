export default {
  ...
  pricesAndPlans: {
    ...
    learnMoreList: [
      ...
      { id: 15, text: "Módulo de recursos humanos" },
      { id: 16, text: "Módulo de Helpdesk Pro" },
      { id: 17, text: "Módulo de proyectos" },
      { id: 18, text: "Módulo de marketing por email" },
      { id: 19, text: "Módulo de comercio electrónico" },
      { id: 20, text: "Módulo de comisiones" },
      { id: 21, text: "Servicio profesional de desarrollo" },
      { id: 22, text: "Servicio profesional de consultoría" },
