export default {
  ...
  pricesAndPlans: {
    ...
    learnMoreList: [
      ...
      {
        id: 2,
        header: "Integraciones Realizables",
        content: [
          "Impresora de Comanda",
          "HKA con impresora fiscal HKA80",
          "WhatsApp",
          "Facturacion Electronica HKA",
          "Facturacion Imprenta Digital HKA",
          "InstaPagos",
          "Integraciones API",
        ],
      },
      ...
      // {
      //   id: 10,
      //   text: "Soporte técnico prioritario vía: helpdesk, correo y teléfono",
      // },
