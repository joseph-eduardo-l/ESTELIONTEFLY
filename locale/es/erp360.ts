export default {
  ...
  pricesAndPlans: {
    ...
    learnMoreList: [
      ...
      { id: 8, text: "Integración con impresora de comanda" },
      { id: 9, text: "Integración con impresora fiscal HKA80" },
      {
        id: 10,
        text: "Integración con whatsapp",
      },
      { id: 11, text: "Integración con facturación electrónica HKA" },
      { id: 12, text: "Integración con facturación de imprenta digital HKA" },
      { id: 13, text: "Integración con Instapagos" },
      { id: 14, text: "Integración con API" },
      { id: 15, text: "Módulo extra de recursos humanos" },
      { id: 16, text: "Módulo extra de Helpdesk Pro" },
      { id: 17, text: "Módulo extra de proyectos" },
      { id: 18, text: "Módulo extra de marketing por email" },
      { id: 19, text: "Módulo extra de comercio electrónico" },
      { id: 20, text: "Módulo extra de comisiones" },
      { id: 21, text: "Servicio profesional de desarrollo" },
      { id: 22, text: "Servicio profesional de consultorías" },
      { id: 23, text: "Servicio profesional de reuniones" },
      {
        id: 24,
        text: "Servicio profesional de inducciones presenciales / virtuales",
      },
    ],
    knowmore: "Conoce más",
    titles: [
