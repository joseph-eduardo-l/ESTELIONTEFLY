export default {
    vinculos: [
        { id: 1, title: 'Home', url: '/' },
        { id: 2, title: '¿Quiénes somos?', url: '/about' },
        {
            id: 3, title: 'Productos y Servicios', url: '',
            consultoria: [
                { id: 0, subtitle: 'Consultoría', url: '/consultancy' },
            ...
            empresariales: [
                { id: 0, subtitle: 'Sistemas Empresariales', url: '/businessSystems' },
            ...
            sistit: [
                { id: 0, subtitle: 'Sistemas IT', url: '/it-systems' },
            ...
            sistiot: [
                { id: 0, subtitle: 'Sistemas IoT', url: '/iot-systems' },
                { id: 1, title: 'CoolTrack - Cadena de frío', url: '/cooltrack', },
                { id: 2, title: 'Monitor 360 - Data Center', url: '/data-center', },
                { id: 3, title: 'Monitor 360 - Smart Retail', url: '/smart-retail', },
            ],
            learning: [
                { id: 0, subtitle: 'Formación y Gestión del Conocimiento', url: '/learning' },
        ...
        { id: 5, title: 'Contáctanos', url: '/contact' }
    ],
}