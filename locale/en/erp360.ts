export default {
  ...
  pricesAndPlans: {
    ...
    learnMoreList: [
      ...
      { id: 8, text: "Integration with command printer" },
      { id: 9, text: "Integration with HKA80 fiscal printer" },
      { id: 10, text: "Integration with WhatsApp" },
      { id: 11, text: "Integration with HKA e-invoicing" },
      { id: 12, text: "Integration with HKA digital press billing" },
      { id: 13, text: "Integration with InstaPagos" },
      { id: 14, text: "API Integration" },
      { id: 15, text: "Human resources module" },
      { id: 16, text: "Helpdesk Pro Module" },
      { id: 17, text: "Project module" },
      { id: 18, text: "Email marketing module" },
      { id: 19, text: "E-commerce module" },
      { id: 20, text: "Commission module" },
      { id: 21, text: "Professional development service" },
      { id: 22, text: "Professional consulting service" },
      { id: 23, text: "Professional meeting service" },
      { id: 24, text: "Professional in-person / virtual induction service" },
    ],
    knowmore: "Know more",
    titles: [
