    ...
    return (
        <Flex maxW='1280px' w='95%' m='20px auto' p='10px' flexDirection={'column'} mt='100px'>
            <Box w='100%'>
                ...
                <Divider m='auto' w='100px' h='5px' bgColor={colorMode === "light" ? "odoo.400" : "#fff"} mb='60px' borderStyle='none' borderRadius="10px" opacity={1}  />
            </Box>
                ...
                {testimonialsMap.map(({ id, testimony, nameAuthor, image, imageDark }) => {
                    return (
                        <GridItem key={id} w='100%' boxShadow='6px 6px 20px 0px rgba(0, 0, 0, 0.08)' borderRadius='16px'>
                            <Flex p='18px' bg={colorMode === 'light' ? '#fff' : '#f4fbfc20'} borderRadius={'10px'} flexDirection={{ base: 'column', md: 'row' }} justifyContent='center' alignItems={'center'} h='100%'>
